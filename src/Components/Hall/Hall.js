  ...
  render() { 
    return(
      <div className = "hall">
        ...
        <Link to={{ pathname: `/buy_ticket/${this.props.film}/${this.props.date}/${this.props.cinema}/${this.props.hall}/${this.props.time}`}}><button className = '123' disabled = {(this.props.selectedSeats.length>6 || this.props.selectedSeats.length === 0) ? true : false }> Buy </button> </Link>
      </div>
    )
  }
}
